...
for (var element of document.getElementById('relevant_for_clientconfig').getElementsByTagName('input')) {
  document
    ...
    .setAttribute('onbeforeinput', 'getElementById("results").setAttribute("style", "display: none")');
}
...
function genCfg() {
  ...
  server_em.setAttribute('href', 'mailto:?' + to + 'subject=' + encodeURIComponent(subject) + '&body=' + encodedfrag);
